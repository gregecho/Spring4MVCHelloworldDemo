...
<html>
  <head>  
    <title>AngularJS $http Example</title>  
     <link rel="stylesheet" href="<c:url value="/static/components/bootstrap/dist/css/bootstrap.css"/>" />
  ...
  <body ng-app="myApp" class="ng-cloak">
      ...
      <script src="<c:url value="/static/components/angular/angular.js"/>"></script>
