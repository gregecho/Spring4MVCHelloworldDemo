...
import com.greg.spring4mvc.model.Computer;
import com.greg.spring4mvc.model.Phone;
import com.greg.spring4mvc.model.Printer;
import com.greg.spring4mvc.model.State;
...
public class ItemServiceImpl implements ItemService {
    ...
    public List findItemsByCategory(String category) {
        ...
        if(category.equalsIgnoreCase("computers")){
            ...
            return phones;
        } else if(category.equalsIgnoreCase("printers")){
            return printers;
        }
        return computers;
    }
